...
describe MassPaymentService do
  ...
  context "for invoices" do
    ...
    it "makes multiple payments if there are more than 1 payee" do
      ...
      engagement2 = FactoryGirl.create(:engagement, tutor_account: tutor2.tutor_account, client_account: client.client_account, student_account: student_account_user_nil)
